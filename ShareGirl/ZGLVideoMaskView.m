...
- (void)layoutSubviews {
    ...
    self.bottomBackgroundView.frame = CGRectMake(0, heihgt - 30, width, 30);
...
//    
//    self.progessView.frame = CGRectMake(CGRectGetMaxX(self.videoSlider.frame), 0, sliderWidth, self.bottomBackgroundView.frame.size.height);
}
